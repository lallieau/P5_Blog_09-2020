...
<nav>
    ...
    <a href="index.php?route=articlesPage" class="link_articles">
    ...
    <a href="index.php?route=contactPage" class="link_contact">
    ...
    <a href="index.php?route=profile" class="link_profil">
