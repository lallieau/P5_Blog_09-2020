...
<nav>
    ...
    {
        echo '<a href="index.php?route=articlesPage" class="page_active">
    ...
    {
        echo
        '<a href="index.php?route=contactPage" class="page_active">
    ...
    {
        echo
        '<a href="index.php?route=profile" class="page_active">
